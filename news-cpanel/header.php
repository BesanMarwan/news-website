                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="<?php ?>" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
                                ...
                                <a class="dropdown-item" href="user-profile.php?id=<?php echo $_SESSION['id']?>">
                                ...
                                <div class="p-l-30 p-10">
                                    <a href="user-profile.php?id=<?php echo $_SESSION['id']?>" class="btn btn-sm btn-success btn-rounded">View Profile</a>
                                </div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
